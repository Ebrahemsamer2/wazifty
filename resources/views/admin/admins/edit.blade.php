                        ...
                        <form method="post" action="{{ route('admins.update', $admin) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('admin') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-password">{{ __('Role') }}</label>
                                    <select required name="admin" id="input-admin" class="form-control form-control-alternative{{ $errors->has('admin') ? 'is-invalid' : '' }}">
                                        
                                        <option value="1" <?php if($admin->admin == 1) echo "selected" ?> >Admin</option>
                                        <option value="0" <?php if($admin->admin == 0) echo "selected" ?> > User</option>
