...
@section('content')
    @include('admin.users.partials.header', [
        'title' => auth()->user()->name . __("'s Jobs"),
        'description' => __('This is your jobs page. You can see all your jobs you added, edit, deleted and activate or deactivate it.'),
        'class' => 'col-lg-10'
    ])
