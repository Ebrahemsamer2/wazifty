        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="col-12">
                    	<form autocomplete="off" id="category-form" class="inline" method="POST" action="{{ route('jobcategories.store') }}">
                    		@csrf
                    		<div class="row">
                    			<div class="col-sm-10">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <form action="{{ route('jobcategories.destroy', $category) }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        
                                                        <a class="dropdown-item" href="{{ route('jobcategories.edit', $category) }}">{{ __('Edit') }}</a>
