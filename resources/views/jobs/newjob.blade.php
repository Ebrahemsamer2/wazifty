	...
	<div class="container">
		<div class="newjob">
			<div class="alert alert-success" role="alert">
			    <h4 class="alert-heading">Some tips!</h4>
			    <ul class="">
			    	<li>Your new job will be active immediatly, so make sure you're specific and clear.</li>
			    	<li>You can not delete jobs, admins take that action. you can deactivate it.</li>
			    </ul>
			    <p class="mb-0"><i class="fas fa-exclamation-triangle"></i> In case that you have promoted an offensive product or advertisement, we will cancel the job and your membership can be canceled.</p>
			</div>

			<h1>New job</h1>

			<form id="newjobform" method="post" action="/newjob" autocomplete="off">
	            @csrf
