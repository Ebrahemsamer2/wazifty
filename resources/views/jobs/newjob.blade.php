...
@section('content')
    @include('admin.jobs.partials.header', ['title' => __('New Job')])  
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="/company/{{ auth()->user()->id }}" class="btn btn-sm btn-primary">{{ __('Back to your jobs list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
						...
						<form id="newjobform" method="post" action="/newjob" autocomplete="off">
				            ...
				            <div class="pl-lg-4">
				                ...
				                <div class="form-group{{ $errors->has('work_place') ? ' has-danger' : '' }}">
				                    ...
				                    <p class="job-work-place-error js-error">Job work place must be between 3 - 50 characters and specific country / city</p>
