        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left-image">
              <img src="/blog_assets/mainimages/our-team.jpg" alt="">
            </div>
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="/blog_assets/mainimages/team-01.jpg" alt="">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="/blog_assets/mainimages/team-02.jpg" alt="">
              <div class="down-content">
                <h4>Mary Morris</h4>
                <span>Co-Founder</span>
              </div>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="/blog_assets/mainimages/team-03.jpg" alt="">
              <div class="down-content">
                <h4>George White</h4>
                <span>Co-Founder</span>
              </div>
